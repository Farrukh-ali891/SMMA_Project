...
const Login = () => {
    return (
        <>
            ...
            <div className="bg-gradient-to-r from-primary_dark from-45% to-primary to-65% font-body_font text-white h-screen pt-4">
                <div className="container mx-auto text-center xl:w-[40%] lg:w-[60%] md:w-[80%] w-full">
                    <h1 className="text-5xl font-semibold leading-snug">Welcome Back <br /> To <br /> <a href="" className="animate-textReveal">Swirl Marketing</a></h1>
                    <hr className="border-b-4 border-purple-600 w-[25%] mx-auto my-5" />
                    <p className="text-xl w-[70%] mx-auto">Please, provide login credential to proceed and have access to all our services</p>
                    ...
                    <form action="" className="py-10">
                        ...
                        <button type="submit" className="block mx-auto bg-gradient-to-r from-[#8b33c5] to-[#15a0e1] px-20 py-3 my-8 text-lg font-semibold tracking-widest rounded-full uppercase transition-all ease-in-out duration-300 hover:-translate-y-1">Login</button>
                        <p className="text-base tracking-wide">Don't have an account? <a href="" className="underline hover:text-gray-400">Sign up</a></p>
                    </form>
                </div>
            </div>
        </>
